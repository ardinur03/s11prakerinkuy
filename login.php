...
{
	if($_GET['pesan'] == "gagal"){
		echo "Login gagal! Harap masukkan username/password dengan benar!!!";
		...
		<div class="container-login100" style="background-image: url('img/bg-img/bg-02.jfif');">
			<div class="wrap-login100">
				<form action="validate.php" method="post">
					...
					<span class="login100-form-title p-b-34 p-t-27"><h3 style="font-family: cursive; font-weight: bold;">
						Please Login</h3>
					</span>
