...
#sidebar-container {
    min-height: 100vh;
    background-color: #dadada; /*#3e3eff */
    padding: 0.3%;
}
.sidebar-expanded {
    width: 230px;
...
<nav class="navbar navbar-expand-md navbar-dark bg-secondary">
  ...
  <a class="navbar-brand" href="../img/logo-img/11bedabisa.png">
    <img src="../img/logo-img/11bedabisa.png" width="50" height="50" class="d-inline-block align-top" alt="IMG NOT FOUND">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown d-sm-block d-md-none">
        <!-- profile mulai -->
        <div class="bg-light">
                <a href="#turun" data-toggle="collapse" aria-expanded="false" class="bg-primary list-group-item list-group-item-action flex-column align-items-start">
                ...
                <div id='turun' class="collapse sidebar"><br><!-- collapse sidebar-submenu -->

                    <center><img src="../img/logo-img/user.png" alt="IMAGE NOT FOUND" class="rounded-circle"><br><p class="nama"><?php echo $_SESSION['nama_user']; ?><br><?php echo $_SESSION['username'];?></p></center>
                    <a href="../logout.php" class="list-group-item list-group-item-action bg-light text-dark">
        ...
        <div class="dropdown-menu" aria-labelledby="smallerscreenmenu">
            <a class="dropdown-item" href="dashboard_siswa.php">Dashboard</a>
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        <ul class="list-group">
            ...
            <div id='submenu2' class="collapse sidebar-submenu">
                <a href="dashboard_siswa.php" class="list-group-item list-group-item-action bg-light text-dark">
                    <span class="fa fa-dashboard fa-fw mr-2"></span>
                    <span class="menu-collapsed">Dashboard</span>
                </a>
                <a href="data_pembimbing.php" class="list-group-item list-group-item-action bg-light text-dark">
                    <span class="fa fa-users fa-fw mr-2"></span>
                    <span class="menu-collapsed">Data Pembimbing</span>
                </a>
                <a href="data_perusahaan.php" class="list-group-item list-group-item-action bg-light text-dark">
